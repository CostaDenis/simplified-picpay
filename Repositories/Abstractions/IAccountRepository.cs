...
namespace simplified_picpay.Repositories.Abstractions
{
    public interface IAccountRepository
    {
        ...
        Task<Account?> GetAccountByPublicIdAsync(string publicId, CancellationToken cancellationToken = default);
        Task<string> GetPublicIdAsync(Guid id, CancellationToken cancellationToken = default);
